...
import Artifacts from "./include/Artifacts";
    ...
    <>
      <div id="layout-wrapper">
        ...
        <div className="main-content">
          {children}
              <div
                className="ht-ctc ht-ctc-chat ctc-analytics ctc_wp_desktop style-2 ht_ctc_animation no-animations"
                id="ht-ctc-chat"
                style={{
                    position: "fixed",
                    bottom: 15,
                 ...
                 onClick={() => window.open('https://wa.me/+971506168540', '_blank')}
            >
                <div className="ht_ctc_style ht_ctc_chat_style">
                    ...
                    >
                        <p
                            className="ctc-analytics ctc_cta ctc_cta_stick ht-ctc-cta  ht-ctc-cta-hover "
                            style={{
                                padding: "0px 16px",
                                lineHeight: "1.6",
                                fontSize: 15,
