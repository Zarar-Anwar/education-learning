              ...
              <div className="col-xl-3 ">
                <div className="footer_widget">
                  ...
                  <p className="description_text">
                    Welcome to our platform where you can enhance your knowledge
                    and skills. Our mission is to provide top-quality learning
                    resources and foster a community of continuous growth.
                  </p>
                </div>
              </div>
